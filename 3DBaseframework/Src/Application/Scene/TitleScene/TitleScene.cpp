...
void TitleScene::Draw()
{
	...
	KdShaderManager::Instance().m_spriteShader.DrawTex(&m_waveTex, (int)m_waveScrollX, 0, 1634, 963);
	KdShaderManager::Instance().m_spriteShader.DrawTex(&m_waveTex, (int)m_waveScrollX + 1634, 0, 1634, 963);
...
void TitleScene::Init()
{
	...
	m_waveTex.Load("Asset/Textures/wave.png");
}
